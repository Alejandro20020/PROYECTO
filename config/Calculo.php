    ...
    <title>Carrito de Compras</title>
     <?php
                ...
                if(isset($_SESSION['persona'])){
                    echo 'Bienvenido! '.$_SESSION['persona'].' '.'<a href="phps/cerrar.php">(Cerrar Sesion)</a>';
...
<body>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">TIENDA DRAGON ASP</a>
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Copyright &copy; ISAAC ALEJANDRO 2023</p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
